...
export default function BulanModal() {
  return (
    <div
      id="hs-pro-shchpdb"
      ...
      role="dialog"
      tabIndex={-1}
      aria-labelledby="hs-pro-shchpdb-label"
    >
              ...
              <div className="flex flex-col justify-between gap-5 lg:gap-0">
                ...
                <div className="px-4 sm:px-6 lg:px-8 flex items-center gap-x-3">
                  <div className="grow pb-8 pt-4">
                    ...
                    <p className="text-xs font-medium text-gray-600">
                      Rekomendasi: Unisex (Pria dan Wanita)
                    </p>
                    <p className="text-xs font-medium text-gray-600">
                      Isi: 50 ml
                    </p>
                    ...
                    <div className="space-y-2 pt-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center gap-5">
                          ...
                          <span className="text-xs text-gray-500">Melon</span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center gap-5">
                          <span className="text-xs text-gray-500">Freesia</span>
                ...
                <div className="px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex gap-3">
                    <Link
                      href={`https://wa.me/+6289679632323?text=Halo%20IFSKY.%20Saya%20tertarik%20dengan%20produk%20IFSKY%20lebih%20tepatnya%20varian%20Bulan%20Scene.`}
                      target="_blank"
