...
export default function MatahariModal() {
  return (
    <div
      ...
      role="dialog"
      tabIndex={-1}
      aria-labelledby="hs-pro-shchpdm-label"
    >
              ...
              <div className="flex flex-col justify-between gap-5 lg:gap-0">
                    ...
                    <div className="space-y-2 pt-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between items-center gap-5">
                          <span className="text-xs text-gray-500">Nutmeg</span>
                ...
                <div className="px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="flex gap-3">
                    <Link
                      href={`https://wa.me/+6289679632323?text=Halo%20IFSKY.%20Saya%20tertarik%20dengan%20produk%20IFSKY%20lebih%20tepatnya%20varian%20Matahari%20Scene.`}
                      target="_blank"
